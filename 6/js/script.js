...
/* harmony import */ var _letter_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./letter-animation */ "./source/js/modules/letter-animation.js");
...
class FullPageScroll {
  ...
  onUrlHashChanged() {
    ...
    if (this.activeScreen === 3) {
      const animationTopScreenTextLine = new _letter_animation__WEBPACK_IMPORTED_MODULE_1__["default"](`.rules__title`, 500, `active`, `transform`);
      setTimeout(()=>{
...
/* harmony import */ var _modules_letter_animation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/letter-animation */ "./source/js/modules/letter-animation.js");
// modules
...
if (isIntroScreen) {
  introMessageElement.ontransitionend = function () {
    const animationDateMane = new _modules_letter_animation__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__date`, 500, `active`, `transform`);
    setTimeout(()=>{
...
const animationTitleMane = new _modules_letter_animation__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__title`, 500, `active`, `transform`);
setTimeout(()=>{
